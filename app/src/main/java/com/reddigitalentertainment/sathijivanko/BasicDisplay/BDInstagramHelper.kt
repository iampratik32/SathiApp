...
import com.reddigitalentertainment.sathijivanko.BasicDisplay.GlobalValues.*
...
class BDInstagramHelper : AuthenticationDialog.AuthenticationListener {
    ...
    fun performLogin(
        ...
        val authenticationDialog = AuthenticationDialog(
                this,
                "https://www.instagram.com/oauth/authorize?client_id=190756095712248&redirect_uri=https://github.com/iampratik32&scope=user_profile,user_media&response_type=code",
                languageCode
        )
